...
with col3:
    ...
    st.markdown("###### Length의 종류 수")
    st.markdown("###### Length의 최소")
    st.markdown("###### Length의 최대")
    st.markdown("###### Length의 다빈도")
    st.markdown("###### Length의 평균/중앙 값")
with col4:
    st.markdown("#####  Value 구성(패턴) 정보")
    st.markdown("###### 영문, 한글, 숫자 등으로 패턴 구성")
    st.markdown("###### 패턴의 종류 수")
    st.markdown("###### 다빈도 패턴의 구성")
    st.markdown("###### 다빈도 패턴 수 및 비율")
    st.markdown("###### 2nd/3rd 패턴 수 및 비율")
with col5:
    st.markdown("#####  Value Top 10 정보")
    st.markdown("###### Top 10 값")
    st.markdown("###### Top 10 비율")
with col6:
    st.markdown("#####  데이터 문자 통계 정보")
    st.markdown("###### 영문 대소문자 포함 열 수")
    st.markdown("###### 한글 및 포함 열 수")
    st.markdown("###### 숫자 포함 열 수")
    st.markdown("###### 특수문자 포함 열 수")
    st.markdown("###### 혼합 문자 포함 열 수")
